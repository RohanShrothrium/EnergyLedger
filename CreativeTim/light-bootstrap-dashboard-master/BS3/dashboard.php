	...
	<script>
		...
		var chart = new CanvasJS.Chart("chartContainer", {
			...
			data: [{
				...
				indexLabel: "{label} {y}",
				dataPoints: [
					{y: 59.31, label: "Non-Renewable", color: "rgba(255,12,32,.8)"},
					{y: 40.69, label: "Renewable", color: "rgba(0,200,83,1)"},
				]
			}]
		});
		chart.render();
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Fraction of Energy Produced</h4>
                                <p class="category">Updated March 20, 2019</p>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tokens Owned</h4>
                                <p class="category">Updated March 20, 2019</p>
                            </div>
                            <div class="content">
                                <?php
                                ...
                                <div class="row">
                                    <div class="col-md-2 mx-3 alert-success">
                                        <?php
